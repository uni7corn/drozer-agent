...
import com.reversec.common.tls.trust_managers.KeyStoreTrustManager;
...
public class Endpoint extends Connector {
    ...
    private String ssl_truststore_path = "/data/data/com.reversec.dz/files/ca.bks";
    ...
    public Endpoint(int id, String name, String host, int port) {
        this(id, name, host, port, false, "/data/data/com.reversec.dz/files/ca.bks", "drozer", "", false);
    }
