...
import com.reversec.dz.service_connectors.ClientServiceConnection;
import com.reversec.dz.service_connectors.IncomingReplyHandler;
import com.reversec.dz.service_connectors.ServerServiceConnection;
...
public class Agent {
	...
	public Server getServerParameters() {
		if(this.server_parameters == null) {
			...
			(new ServerSettings()).load(getContext(), this.server_parameters);
		}
